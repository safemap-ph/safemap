...
## How Report Statuses Work

Every report goes through a lifecycle of statuses. Here is how it works:
...
- This means the incident is noted for community awareness but has NOT been officially confirmed by PNP.
...
- This is the highest level of validation — it means PNP has officially confirmed the incident.
...
- Personal details are automatically removed.
- The report is kept in the database for audit purposes but is not shown to the public.
...
- Pending Review: ⏳
- Approved for Awareness: ✅ (visible on heatmap)
- Verified / PNP Confirmed: ✅ (visible as marker)
- Dismissed: ❌
