          ...
          <section className="space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                SafeMap PH is a community-driven platform designed to modernize how we report and respond to incidents in our neighborhoods. Our mission is to provide a transparent, fast, and anonymous way for citizens to contribute to public safety.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 bg-primary/5 rounded-3xl space-y-4">
                ...
                <p className="text-slate-600">
                  To become the standard for community safety technology in Southeast Asia, starting with the Philippines.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-600">We don't track your personal identity. We focus on the data that helps responders save lives.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center shrink-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-600">Our platform syncs directly with local police, fire, and medical units for the fastest possible dispatch.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center shrink-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-600">View safety trends in your area and take proactive measures to keep your family safe.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-20 border-t border-slate-100 text-center space-y-8">
              ...
              <p className="text-slate-600">Whether you're a concerned citizen or a local authority unit, we'd love to partner with you.</p>
              <button 
