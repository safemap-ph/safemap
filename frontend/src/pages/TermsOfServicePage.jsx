      ...
      <div className="w-full max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing and using SafeMap-PH, you accept and agree to be bound by these Terms of Service. If you do
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <strong>Provide Accurate Information:</strong> Submit truthful and accurate incident reports
              </li>
              <li>
                <strong>No False Reports:</strong> Do not submit false, misleading, or malicious reports
              </li>
              <li>
                <strong>Respect Privacy:</strong> Do not include personal identifying information of others without
                consent
              </li>
              <li>
                <strong>No Harassment:</strong> Do not use the platform to harass, threaten, or harm others
              </li>
              <li>
                <strong>Legal Compliance:</strong> Use the service in compliance with all applicable laws
              </li>
              <li>
                <strong>Emergency Protocol:</strong> In case of immediate danger, call 911 or local emergency services
                directly
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Your use of SafeMap-PH is also governed by our Privacy Policy. Please review it to understand how we
          ...
          <section>
            ...
            <p>
              All content, trademarks, and intellectual property on SafeMap-PH are owned by the platform or its
          ...
          <section>
            ...
            <p>
              We may terminate or suspend your access to SafeMap-PH at any time, without notice, for conduct that
          ...
          <section>
            ...
            <p>
              These terms are governed by the laws of the Republic of the Philippines. Any disputes shall be resolved in
              the courts of General Santos City.
            </p>
          </section>
