  ...
  features: [
    ...
    },
    {
      properties: {
        ...
        type: "rescue",
        contact: "887-6018 / 0905-144-3676",
        lat: 6.1148,
        lng: 125.1712,
      },
    },
...
export default function EmergencyPage() {
  ...
  useEffect(() => {
    ...
    const nearest = centersWithDistance.sort((a, b) => a.distance - b.distance).slice(0, 5)

    setSupportCenters(nearest)
  }, [userLocation])

  const currentLocationText =
    userLocation.lat !== 6.1167
      ? `${userLocation.lat.toFixed(4)}, ${userLocation.lng.toFixed(4)}`
      : "Jollibee, General Santos City"
    ...
    <div className="w-full h-screen bg-slate-50 overflow-y-auto">
            ...
            <div className="w-full h-44 bg-white/90 rounded-2xl shadow-[0px_1px_6px_0px_rgba(0,0,0,0.05)] border-l-[5px] border-red-500 overflow-hidden p-4">
              <div className="w-full h-full inline-flex flex-col justify-center items-center gap-4">
                ...
                <div className="flex flex-col justify-center items-center gap-2">
                  <div className="text-center text-blue-900 text-base font-bold font-['DM_Sans'] tracking-tight">
                    TASK FORCE GENSAN
                  </div>
                  <div className="text-center text-gray-600 text-xs font-normal font-['DM_Sans'] tracking-tight">
                    887-6018
                    <br />
                    +63 05-114-3676
                  </div>
            ...
            <div className="w-full h-44 bg-white/90 rounded-2xl shadow-[0px_1px_6px_0px_rgba(0,0,0,0.05)] border-l-[5px] border-blue-900 overflow-hidden p-4">
              <div className="w-full h-full inline-flex flex-col justify-center items-center gap-4">
                <div className="w-10 h-10 p-2 bg-blue-50 rounded-[20px] inline-flex justify-center items-center">
                  <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
                    <path
                      d="M12 2C8.686 2 6 4.686 6 8C6 12 12 22 12 22C12 22 18 12 18 8C18 4.686 15.314 2 12 2Z"
                      fill="#1E3A8A"
                    />
      ...
      <div className="w-full max-w-md mx-auto px-4 mt-4 flex gap-3">
        ...
        <div className="flex-1 h-40 p-4 bg-blue-900 rounded-lg flex flex-col justify-center gap-2">
          ...
          <div className="flex flex-col justify-start gap-1">
            <div className="text-white text-lg font-extrabold font-['DM_Sans'] tracking-tight">
              Stay in a well-lit area
            </div>
            <div className="text-white text-xs font-normal font-['DM_Sans'] tracking-tight">
              Move towards crowds or open establishments.
            </div>
          </div>
        </div>
        ...
        <div className="w-36 h-40 bg-white/90 rounded-2xl shadow-[0px_1px_6px_0px_rgba(0,0,0,0.05)] border-l-[5px] border-amber-500 overflow-hidden p-4 flex flex-col justify-center items-center gap-2">
          ...
          <div className="text-center text-blue-900 text-sm font-extrabold font-['DM_Sans'] tracking-tight">
            Keep phone charged
          </div>
        </div>
      </div>
          ...
          <div className="w-full h-full px-5 py-3 inline-flex justify-start items-center gap-3.5">
            <div className="w-10 h-10 p-2.5 bg-blue-100 rounded-md flex justify-start items-start gap-2.5">
              <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
                <path
                  d="M10 2C6.686 2 4 4.686 4 8C4 12 10 18 10 18C10 18 16 12 16 8C16 4.686 13.314 2 10 2Z"
                  fill="#1E3A8A"
                />
            ...
            <div className="flex-1 inline-flex flex-col justify-start items-start gap-1">
              <div className="self-stretch justify-start text-zinc-800 text-xs font-bold font-['DM_Sans'] tracking-tight">
                Note your surroundings
              </div>
              <div className="justify-start text-gray-400 text-xs font-normal font-['DM_Sans'] tracking-tight">
                Remember street names or landmarks nearby.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full max-w-md mx-auto px-4 mt-3">
        {supportCenters.map((center, index) => (
          <div
            key={index}
            className="w-full h-36 bg-white rounded-tl-xl rounded-bl-xl shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08)] border-l-[5px] border-blue-950 overflow-hidden mb-3 p-4"
          >
            <div className="flex justify-between items-start mb-3">
              <div className="flex justify-start items-start gap-3.5">
                ...
                >
                  ...
                  {center.type === "fire" && (
                    <svg className="w-6 h-6 text-amber-500" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2c-3.5 2-6 4.5-6 7.5 0 2.5 2.5 4 4 5.5 1.5-1.5 3-2.5 4.5-2.5.5 0 1 0 1.5.5-2.5-3-3.5-4.5-4-5.5-.5 1-.5 2.5-.5 4 2.5-.5 5-2 5-4 0-3-2.5-5.5-5-7.5z" />
                    </svg>
                  )}
                  {center.type === "rescue" && (
                ...
                <div className="inline-flex flex-col justify-start items-start gap-1">
                  <div className="self-stretch justify-start text-zinc-800 text-base font-bold font-['DM_Sans'] tracking-tight">
                    {center.name}
                  </div>
                  <div className="self-stretch justify-start text-gray-400 text-xs font-semibold font-['DM_Sans'] tracking-tight capitalize">
                    {center.type}
                  </div>
                </div>
              </div>
              <div className="h-5 p-2 bg-blue-50 rounded-md inline-flex justify-center items-center gap-2.5">
                <div className="justify-start text-blue-900 text-[10px] font-bold font-['DM_Sans'] tracking-tight">
                  {center.distance} km
                </div>
              </div>
            </div>
            <div className="flex justify-start items-center gap-2">
              ...
              >
                <div className="flex justify-start items-end gap-2">
                  ...
                  <div className="text-center justify-start text-white text-xs font-semibold font-['DM_Sans'] tracking-tight">
                    Get Directions
                  </div>
                </div>
              </a>
          ...
          <div className="self-stretch inline-flex justify-between items-center">
            <div className="flex justify-start items-center gap-3.5">
              <div className="w-10 h-10 p-2 bg-white rounded-[20px] flex justify-center items-center">
                <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
                  <path
                    d="M12 2C8.686 2 6 4.686 6 8C6 12 12 18 12 18C12 18 18 12 18 8C18 4.686 15.314 2 12 2Z"
                    fill="#1E3A8A"
                  />
                  <circle cx="12" cy="8" r="2" fill="white" />
                </svg>
              ...
              <div className="w-64 inline-flex flex-col justify-start items-start gap-1">
                <div className="self-stretch justify-start text-zinc-800 text-xs font-medium font-['DM_Sans'] tracking-tight">
                  Your current location
                </div>
                <div className="self-stretch justify-start text-blue-900 text-base font-bold font-['DM_Sans'] tracking-tight">
                  {currentLocationText}
                </div>
              </div>
            </div>
