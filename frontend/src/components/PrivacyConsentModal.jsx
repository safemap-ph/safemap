...
const PrivacyConsentModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in duration-300">
        {/* Header */}
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-gray-50/50">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm leading-relaxed">
                  The Professional Regulation Commission (PRC) is committed to protecting your privacy and ensuring that
                  all personal data collected are processed in accordance with the Data Privacy Act of 2012 (Republic
                  Act No. 10173).
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200 text-sm text-gray-600 space-y-4 shadow-sm">
            <div>
              ...
              <p>
                The PRC collects personal information either manually or electronically through transactional websites
                (LERIS, CPDAS, ACOAS, CRMS) including complete name, date of birth, license number, etc. We also use
            ...
            <div>
              ...
              <p>
                Data is used to perform mandates relative to regulation and licensing of professions, provide better
                service, and respond to data privacy rights requests.
              </p>
            </div>
            <div>
              <strong className="text-gray-900 block mb-1">3. Disclosure & Security</strong>
              <p>
                Information is only shared if required by law. The PRC implements technical, physical, and
                organizational security measures to protect your personal data against unauthorized access or breaches.
              </p>
            </div>
            <div>
              <strong className="text-gray-900 block mb-1">4. Rights of Data Subjects</strong>
              <p>
                You have the right to be informed, access, object, erasure, damages, rectification, data portability,
                and to file a complaint before the PRC.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 bg-white border-t border-gray-100">
          ...
          >
            <div className="flex items-center mt-0.5 shrink-0">
              <div
                className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${isAgreed ? "bg-blue-600 border-blue-600" : "bg-white border-gray-300"}`}
              >
                {isAgreed && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-sm text-gray-700">
              <span className="font-semibold text-gray-900">I acknowledge and agree</span> that I have read, understood,
              and accept the PRC Privacy Notice. I understand how my personal information is collected, used, and
              protected.
            </p>
          </div>
